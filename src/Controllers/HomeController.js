...
export const handleAddToCart = async (User_Id, P_Id, Buy_Quantity, Price, P_Name, Desc, P_Thumbnail) => {
  ...
  if (isLogin && token) {
    ...
    const cartItem = { P_Id, P_Name, Desc, Buy_Quantity, Price, P_Thumbnail };
    try {
